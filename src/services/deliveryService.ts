...
export const handleScheduleDelivery = async (delivery: Omit<Delivery, 'id' | 'createdAt' | 'updatedAt'>): Promise<{ success: boolean; deliveryId?: string; error?: string }> => {
  return await addDeliveryToFirestore(delivery);
};